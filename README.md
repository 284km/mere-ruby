...
and under `./mere-ruby` and diffs the output byte-for-byte: **194 programs,
194 identical**. The corpus covers the semantic corners above. A deliberate negative control (lossy float
...
The record covers **1221 spec files** across 31 groups: **936 MATCH, 281 DIFF,
