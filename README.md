...
```sh
./run_corpus.sh                                  # 197 programs, byte-for-byte
...
and under `./mere-ruby` and diffs the output byte-for-byte: **197 programs,
197 identical**. The corpus covers the semantic corners above. A deliberate negative control (lossy float
...
The record covers **1221 spec files** across 31 groups: **983 MATCH, 234 DIFF,
