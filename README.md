...
```sh
./run_corpus.sh                                  # 203 programs, byte-for-byte
...
and under `./mere-ruby` and diffs the output byte-for-byte: **203 programs,
203 identical**. The corpus covers the semantic corners above. A deliberate negative control (lossy float
...
The record covers **1221 spec files** across 31 groups: **1020 MATCH, 197 DIFF,
